          ...
          if (contentType.includes('application/json')) {
            try {
              ...
              if (matchingRule.responseBodyTransform && responseBody !== null) {
                ...
                // Create context with the response body and make params available
                ...
                logger.debug({ contextWithResponse }, 'Context for response body transformation')
 ...
 */
function transformResponseBody (responseBody, rule, context, logger = abstractLogging) {
  ...
  try {
    ...
    const transformedResults = compiledFgh(responseBody)
