 ...
 */
export function createHandlerWrapper (options, handler, router) {
 ...
 */
export function createInterceptorFunction (router) {
  return function cachingInterceptor (dispatch) {
    return function cachedDispatch (options, handler) {
      return dispatch(
        options,
        createHandlerWrapper(options, handler, router)
      )
    }
  }
}
